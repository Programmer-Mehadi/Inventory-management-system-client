                ...
                <div className="card max-w-[500px] w-[90%] mx-auto shadow-2xl bg-base-100 ">
                    <form onSubmit={handleSubmit(handleSignup)} className="card-body">
                        ...
                        <div className="form-control">
                            ...
                            <input type="password" placeholder="password" className="input input-bordered" {...register("confirmpassword", {
                                required: "Confirm Password is required", minLength: 6
                            })} />
                            {
                                errors.confirmpassword && <p className='text-red-500 my-1'>{errors.confirmpassword.message}</p>
                            }
                            {errors.confirmpassword && errors.confirmpassword.type === "minLength" && <p className='text-red-500 my-1'>Confirm Password length atleast 6 characters.</p>}
                            {
